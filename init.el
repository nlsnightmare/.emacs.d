...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (rainbow-mode xkcd xkcd-mode google-this avy nlinum indent-guide restclient nodejs-repl magit helm try flycheck company evil-visual-replace evil-numbers yasnippet web-mode neotree emmet-mode hl-todo rainbow-delimiters company-c-headers company-tern elpy irony-eldoc iront-eldoc company-irony irony-mode flycheck-irony flycheck-mode js2-mode tern tern-mode dashboard key-chord all-the-icons company-lua lua-mode airline-themes powerline atom-one-dark-theme atom-one-dark evil-surround evil-leader evil use-package org-bullets))))
(custom-set-faces
